...
<div id="post-<?php the_ID(); ?>" <?php post_class('article mdl-cell mdl-cell--14-col mdl-card mdl-shadow--4dp'); ?>>    
                <!-- mdl-card__media -->
		...
		<div class="entry-content mdl-color-text--grey-600 mdl-card__supporting-text">
                    <header>
                            <?php the_title( sprintf( '<h4><a style="%s" href="%s" rel="bookmark">', $title_color, esc_url( get_permalink() ) ), '</a></h4>' ); ?>
                    </header><!-- .entry-header -->
			<?php /*
				the_excerpt( sprintf(
...
>>>>>>> f4219a46b2d9cfab412eadbd4bc3fc6df57da0f7
